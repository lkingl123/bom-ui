...
export default function IngredientSearch({ onSelect, onClose }: IngredientSearchProps) {
    ...
    const fetchIngredients = async () => {
      try {
        ...
        if (res.ok) {
          ...
          setFilteredIngredients(data.slice(0, 20));
        }
      } catch (error) {
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-gray-500">{ingredient.uom || "unit"}</div>
                    </div>
                  </div>
                </button>
              ))}
